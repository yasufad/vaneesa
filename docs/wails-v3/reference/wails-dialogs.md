...
Complete reference for native dialog APIs.
...
**Parameters:**
- `displayName` - Filter description shown to user
...
**Note:** The table above shows GTK4 behavior when building with `-tags gtk4`. By default, Wails uses GTK3 which provides full control over these dialog options.
