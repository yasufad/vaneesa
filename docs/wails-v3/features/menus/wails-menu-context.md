...
**Caution:** Always validate context data from the frontend. Users can manipulate CSS properties, so treat data as untrusted input.
...
**Menu Reference** - Complete reference for menu item types and properties.

[Learn More →](/features/menus/reference)

**Application Menus** - Create application menu bars.

[Learn More →](/features/menus/application)

**System Tray Menus** - Add system tray/menu bar integration.

[Learn More →](/features/menus/systray)

**Menu Patterns** - Common menu patterns and best practices.
