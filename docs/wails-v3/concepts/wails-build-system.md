...
Understanding how Wails builds and packages your application.
...
1. **Analysis Phase** - Scan Go code for services
2. **Generation Phase** - Generate TypeScript bindings and build frontend
3. **Compilation Phase** - Compile Go and embed assets
4. **Output** - Single native binary
