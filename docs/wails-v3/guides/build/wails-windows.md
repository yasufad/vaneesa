...
Package your Wails application for Windows distribution.
...
**Note:** MSIX requires either `makeappx.exe` (Windows SDK) or the MSIX tool. Run `wails3 tool msix-install-tools` to set up.
