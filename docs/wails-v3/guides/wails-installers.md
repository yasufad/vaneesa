...
**WiX Toolset:** Alternative for MSI installers.
...
**App Store:** Use Xcode for App Store distribution.
...
**RPM Package:** Use `rpmbuild` for RPM-based distributions.
...
- Don't forget to test on clean systems
- Don't omit version information
- Don't skip uninstaller creation
